...
const mockConfig: BarSliderConfig = {
  ...
  segments: [
    {
      stylePrefix: 'mock-style-1',
    },
    {
      stylePrefix: 'mock-style-2',
    },
    {
      stylePrefix: 'mock-style-3',
    },
  ],
};
...
describe('calculateWeights', () => {
  it('calculates weights for segments with and without weight', () => {
    const config: BarSliderConfig = {
      ...mockConfig,
      segments: [
        { start: 0, end: 20, weight: 30, stylePrefix: 'style1' },
        { start: 20, end: 40, stylePrefix: 'styles2' },
        { start: 40, end: 60, weight: 30, stylePrefix: 'styles3' },
        { start: 60, end: 100, stylePrefix: 'styles4' },
      ],
    };
  ...
  it('throws error for invalid weight (total weight > 100)', () => {
    const config: BarSliderConfig = {
      ...mockConfig,
      segments: [
        { start: 0, end: 20, weight: 80, stylePrefix: 'style1' },
        { start: 20, end: 40, weight: 30, stylePrefix: 'styles2' },
        { start: 40, end: 60, stylePrefix: 'styles3' },
        { start: 60, end: 100, stylePrefix: 'styles4' },
      ],
    };
