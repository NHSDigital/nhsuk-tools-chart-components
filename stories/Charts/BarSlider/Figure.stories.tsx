 ...
 *  - `stylePrefix`: The CSS class applied to the segment.
 ...
 *
 * Each segement the chart requires a  unique CSS class name. This is done by combining the chart name with the `stylePrefix` property of the segment.
 *
 *  For example, if the name is `nhsuk-bar-slider` and the `segment.stylePrefix` is `cyan`, the final CSS class name will be `nhsuk-bar-slider-cyan`.
